...
def set_notice(title, content, id=1, app_id=103000, region=1, weight=1, start_time=int(time.time()),
    ...
    # print set_notice('666666', content={"htmlpic":"https://dfqppic.266.com/dfqp/pic/task/khlvh7rg.jpg", "cmd": 1003, "gameid": 203, "level": 12, "matchconfigid": 12323232}, id=103000, end_time=int(time.time() + 60 * 4), is_html=2)
...
def add_mission(name='test', desc='test', region=1, sort_order=1,
                icon='https://dfqppic.266.com/dfqp/pic/task/sq41phvu.jpg', reward_type=0, reward=1,
    ...
    #     "desc": "测试",
    #     "sort_order": "1",
    #     "icon": "https://dfqppic.266.com/dfqp/pic/task/khlvh7rg.jpg",
    #     "reward_type": "0",
    #     "reward": "1",
    #     "circle_type": "0",
    #     "jump_code": "1007",
